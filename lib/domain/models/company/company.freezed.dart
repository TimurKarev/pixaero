...
class _$CompanyTearOff {
  ...
  _Company call(
      {required String name, required String bs, required String catchPhrase}) {
    return _Company(
      name: name,
      bs: bs,
...
abstract class $CompanyCopyWith<$Res> {
  ...
  $Res call({String name, String bs, String catchPhrase});
}
...
class _$_Company implements _Company {
  ...
  @override
  String toString() {
    return 'Company(name: $name, bs: $bs, catchPhrase: $catchPhrase)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, bs, catchPhrase);
...
abstract class _Company implements Company {
  const factory _Company(
      ...
      required String bs,
      required String catchPhrase}) = _$_Company;
